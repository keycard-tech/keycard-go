...
func TestDeriveKey(t *testing.T) {
	cardKey := hexutils.MustHexToBytes("404142434445464748494a4b4c4d4e4f")
	seq := hexutils.MustHexToBytes("0065")
...
func TestResizeKey24(t *testing.T) {
	key := hexutils.MustHexToBytes("404142434445464748494a4b4c4d4e4f")
...
func TestVerifyCryptogram(t *testing.T) {
	encKey := hexutils.MustHexToBytes("16B5867FF50BE7239C2BF1245B83A362")
	hostChallenge := hexutils.MustHexToBytes("32da078d7aac1cff")
	cardChallenge := hexutils.MustHexToBytes("007284f64a7d6465")
	cardCryptogram := hexutils.MustHexToBytes("05c4bb8a86014e22")
...
func TestMac3des(t *testing.T) {
	key := hexutils.MustHexToBytes("16B5867FF50BE7239C2BF1245B83A362")
	data := hexutils.MustHexToBytes("32DA078D7AAC1CFF007284F64A7D64658000000000000000")
...
func TestMacFull3DES(t *testing.T) {
	key := hexutils.MustHexToBytes("5b02e75ad63190aece0622936f11abab")
	data := hexutils.MustHexToBytes("8482010010810b098a8fbb88da")
